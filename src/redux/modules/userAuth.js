...
// login sucess:
// //////////////////
export function receivedUserLoggedIn(userToken = null,
  user = emptyUser, time = moment().format(dateFormat)) {
  ...
  auth.setToken(userToken); // set token to default store =
  // localStorage and to default token key = 'token'
...
// register sucess:
// //////////////////
export function receivedUserRegister(userToken = null,
  user = emptyUser, time = moment().format(dateFormat)) {
  const isAuthenticated = !!userToken;
...
// register error:
// //////////////////
export function errorUserRegister(error = null,
  time = moment().format(dateFormat)) {
  auth.clearAllAppStorage(); // clear previous token
